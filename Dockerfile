...
RUN mkdir -p /usr/src/geofunceme
...
COPY src /usr/src/geofunceme/
WORKDIR /usr/src/geofunceme
...
RUN chmod +x /usr/src/geofunceme/tasks.py \
    && chmod +x /usr/src/geofunceme/entrypoint.sh
...
# ENTRYPOINT /usr/src/geofunceme/entrypoint.sh
